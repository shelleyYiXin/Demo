...
public class Register extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		out.println("		</table>");
		out.println("		<br>");
		out.println("		<form method=\"post\" name=\"reg\" onsubmit=\"return validate(this)\" action=\" /Demo/productList\">");
		...
		out.println("				<input value=\"注 册\" type=\"submit\" onclick=\" /Demo/productList\">&nbsp;&nbsp;");
