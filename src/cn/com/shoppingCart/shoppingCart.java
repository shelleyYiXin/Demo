...
public class shoppingCart extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		PrintWriter out = resp.getWriter();
		 ...
		 out.println("				<form>");
		 out.println("					<input type=\"button\" value=\"提交订单\" size=\"1\" onclick=\"javascript:window.location=' /Demo/orderConfirm';\">");
		 out.println("					<input type=\"button\" value=\"继续购物\" size=\"2\" onclick=\"javascript:window.location=' /Demo/productList';\">");
		 out.println("					<input type=\"button\" value=\"清空购物车\" size=\"2\" onclick=\"javascript:window.location=' /Demo/productList';\">");
		 out.println("				</form>");
		 out.println("				</td>");
		 out.println("			</tr>");
		 out.println("		</table>");
