...
public class orderDetail extends HttpServlet {
	...
	private void toOrderDetailList(HttpServletResponse resp, List orderdetailList)
		...
		//resp.setCharacterEncoding("utf-8");改成这个也对。
		PrintWriter out  = resp.getWriter();
		...
		out.println("		<link href=\"css/tarena.css\" rel=stylesheet>");//"css/tarena.css是相对路径"  “/css/tarena.css是绝对路径”
		out.println("	</head>");
		...
		out.println("					<a href= index.jsp>达内电子商务门户</a> → <a href=\"/Demo/orderList\">定单列表</a>  → <b>定单明细</b>");
		out.println("				</td>");
		out.println("			</tr>");
		out.println("		</table>");
		...
		out.println("    			合计：<font color=\"red\"><b>"+orderdetail.getCost()+"</b><font>");
		out.println("    			</td>");
		out.println("			</tr>");
		out.println("		</table>");
		}
